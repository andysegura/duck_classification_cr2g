...
import 'package:animal_classification/BodyParts/body_dorsal.dart';
...
class HeadVentralResult extends StatefulWidget {
  File _image;
  Map _results;
  HeadVentralResult(this._image, this._results);

  @override
  _HeadVentralResultState createState() => _HeadVentralResultState(_image, _results);
}

class _HeadVentralResultState extends State<HeadVentralResult> {
  File _image;
  Map _results;

  _HeadVentralResultState(this._image, this._results);
